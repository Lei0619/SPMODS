        ...
        <CRow>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            The default list group is an unordered list with
                            items and the proper CSS classes. Build upon it with
                            the options that follow, or with your CSS as
                            required.
                        </p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            <code>&lt;CListGroupItem&gt;</code> to show the
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            <code>&lt;CListGroupItem&gt;</code> to make it
                            appear disabled.
                        </p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            <em>actionable</em> list group items with hover,
                            disabled, and active states by adding{' '}
                            <code>as=&#34;a|button&#34;</code>. We separate
                            these pseudo-classes to ensure list groups made of
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Add <code>flush</code> boolean property to remove
                            some borders and rounded corners to render list
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Add <code>layout=&#34;horizontal&#34;</code> to
                            change the layout of list group items from vertical
                            to horizontal across all breakpoints. Alternatively,
                            ...
                            <strong>
                                horizontal list groups cannot be combined with
                                flush list groups.
                            </strong>
                        </p>
                        <DocsExample href="components/list-group/#flush">
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Use contextual classes to style list items with a
                        ...
                        <p className="text-body-secondary small">
                            ...
                            <code>&lt;a&gt;</code>s or{' '}
                            <code>&lt;button&gt;</code>s. Note the addition of
                            the hover styles here not present in the previous
                            example. Also supported is the <code>active</code>{' '}
                            state; apply it to indicate an active selection on a
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            groups like the one below, with the help of{' '}
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Place CoreUI&#39;s checkboxes and radios within list
                            group items and customize as needed.
                        </p>
