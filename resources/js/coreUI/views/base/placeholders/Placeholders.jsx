        ...
        <CRow>
            <CCol xs={12}>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            In the example below, we take a typical card
                            component and recreate it with placeholders applied
                            to create a &#34;loading card&#34;. Size and
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            <code>&lt;CPlaceholder&gt;</code> component and a
                            grid column propx (e.g., <code>xs={6}</code>) to set
                            the <code>width</code>. They can replace the text
                            inside an element or be added as a modifier class to
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            By default, the <code>&lt;CPlaceholder&gt;</code>{' '}
                            uses <code>currentColor</code>. This can be
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            The size of <code>&lt;CPlaceholder&gt;</code>s are
                            based on the typographic style of the parent
                            element. Customize them with <code>size</code> prop:{' '}
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            <code>animation=&#34;glow&#34;</code> or{' '}
                            <code>animation=&#34;wave&#34;</code> to better
                            convey the perception of something being{' '}
