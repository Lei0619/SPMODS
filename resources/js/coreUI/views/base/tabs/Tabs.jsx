        ...
        <CRow>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            <code>variant=&#34;tabs&#34;</code> props to
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            If you don’t provide the <code>variant</code> prop,
                            the component will default to a basic style.
                        </p>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    <CCardHeader>
                        <strong>React Tabs</strong>{' '}
                        <small>Underline border</small>
                    </CCardHeader>
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Take that same code, but use{' '}
                            <code>variant=&#34;underline-border&#34;</code>{' '}
                            instead:
                        </p>
                        <DocsExample href="components/tabs/#unstyled">
                            <CTabs activeItemKey={2}>
