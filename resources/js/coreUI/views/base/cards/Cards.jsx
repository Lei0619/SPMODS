        ...
        <CRow>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Cards are built with as little markup and styles as
                            possible but still manage to deliver a bunch of
                            control and customization. Built with flexbox, they
                            offer easy alignment and mix well with other CoreUI
                            components. Cards have no top, left, and right
                            margins by default, so use{' '}
                            <a href="https://coreui.io/docs/utilities/spacing">
                                spacing utilities
                            </a>{' '}
                            as needed. They have no fixed width to start, so
                            they&#39;ll fill the full width of its parent.
                        </p>
                        <p className="text-body-secondary small">
                            Below is an example of a basic card with mixed
                            content and a fixed width. Cards have no fixed width
                            to start, so they&#39;ll naturally fill the full
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            <code>&lt;CCardBody&gt;</code>. Use it whenever you
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    <CCardHeader>
                        <strong>Card</strong>{' '}
                        <small>Titles, text, and links</small>
                    </CCardHeader>
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Card titles are managed by{' '}
                            <code>&lt;CCardTitle&gt;</code> component.
                            Identically, links are attached and collected next
                            to each other by <code>&lt;CCardLink&gt;</code>{' '}
                            component.
                        </p>
                        <p className="text-body-secondary small">
                            ...
                            <code>&lt;CCardSubtitle&gt;</code> items are stored
                            in a <code>&lt;CCardBody&gt;</code> item, the card
                            title, and subtitle are arranged rightly.
                        </p>
                        <DocsExample href="components/card/#titles-text-and-links">
                            <CCard style={{ width: '18rem' }}>
                                <CCardBody>
                                    <CCardTitle>Card title</CCardTitle>
                                    <CCardSubtitle className="text-body-secondary mb-2">
                                        Card subtitle
                                    </CCardSubtitle>
                                    <CCardText>
                                        Some quick example text to build on the
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            <code>.card-img-top</code> places a picture to the
                            top of the card. With <code>.card-text</code>, text
                            can be added to the card. Text within{' '}
                            <code>.card-text</code> can additionally be styled
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Create lists of content in a card with a flush list
                            group.
                        </p>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Combine and match many content types to build the
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Cards assume no specific <code>width</code> to
                            start, so they&#39;ll be 100% wide unless otherwise
                            stated. You can adjust this as required with custom
                            CSS, grid classes, grid Sass mixins, or services.
                        </p>
                        <h3>Using grid markup</h3>
                        <p className="text-body-secondary small">
                            Using the grid, wrap cards in columns and rows as
                            needed.
                        </p>
                        ...
                        <p className="text-body-secondary small">
                            Use custom CSS in your stylesheets or as inline
                            styles to set a width.
                        </p>
                        <DocsExample href="components/card/#sizing">
                            <CCard style={{ width: '18rem' }}>
                                <CCardBody>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            <code>&lt;CCardHeader&gt;</code> with our{' '}
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            top and bottom &#34;image caps&#34;—images at the
                            top or bottom of a card.
                        </p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            backgrounds, borders, and color.
                        </p>
                        <h3>Background and color</h3>
                        <p className="text-body-secondary small">
                            Use <code>color</code> property to change the
                        ...
                        <p className="text-body-secondary small">
                            ...
                            to change just the <code>border-color</code> of a
                            card. Note that you can set <code>textColor</code>{' '}
                            property on the <code>&lt;CCard&gt;</code> or a
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Use card groups to render cards as a single,
                            attached element with equal width and height
                            columns. Card groups start off stacked and use{' '}
                            <code>display: flex;</code> to become attached with
                            uniform dimensions starting at the <code>sm</code>{' '}
                            breakpoint.
                        </p>
                        ...
                        <p className="text-body-secondary small">
                            When using card groups with footers, their content
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            property to control how many grid columns (wrapped
                            around your cards) you show per row. For example,
                            here&#39;s{' '}
                            <code>xs=&#123;&#123;cols: 1&#125;&#125;</code>{' '}
