        ...
        <CRow>
            <CCol xs={12}>
                            ...
                            <CAccordion activeItemKey={2}>
                                <CAccordionItem itemKey={1}>
                                    ...
                                    <CAccordionBody>
                                        ...
                                        It&#39;s also worth noting that just
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            <code>background-color</code>, some borders, and
                            some rounded corners to render accordions
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Add <code>alwaysOpen</code> property to make
                            accordion items stay open when another item is
                            opened.
                        </p>
                        <DocsExample href="components/accordion#flush">
