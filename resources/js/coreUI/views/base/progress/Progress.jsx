        ...
        <CRow>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Add labels to your progress bars by placing text
                            within the <code>&lt;CProgressBar&gt;</code>.
                        </p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            <code>&lt;CProgress&gt;</code>, so if you change
                            that value the inner{' '}
                            <code>&lt;CProgressBar&gt;</code> will automatically
                            resize accordingly.
                        </p>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Use <code>color</code> prop to change the appearance
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Include multiple progress bars in a progress
                            component if you need.
                        </p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            <code>&lt;CProgressBar&gt;</code> to apply a stripe
                            via CSS gradient over the progress bar&#39;s
                            background color.
                        </p>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    <CCardHeader>
                        <strong>React Progress</strong>{' '}
                        <small>Animated stripes</small>
                    </CCardHeader>
                    <CCardBody>
                        <p className="text-body-secondary small">
                            The striped gradient can also be animated. Add{' '}
                            <code>animated</code> property to{' '}
                            <code>&lt;CProgressBar&gt;</code> to animate the
