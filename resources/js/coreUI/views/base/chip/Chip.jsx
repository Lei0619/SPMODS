        ...
        <CRow>
            <CCol xs={12}>
                ...
                <CCard className="mb-4">
                    <CCardHeader>
                        <strong>React Chip</strong>{' '}
                        <small>Basic and outline</small>
                    </CCardHeader>
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Chips are compact UI elements for labels, filters,
                            and quick selections. Use the <code>CChip</code>{' '}
                            component with optional <code>variant</code> prop.
                        </p>
                        ...
                        <p className="text-body-secondary small">
                            Add <code>variant=&#34;outline&#34;</code> to create
                            a lighter, bordered appearance.
                        </p>
                ...
                <CCard className="mb-4">
                    <CCardHeader>
                        <strong>React Chip</strong>{' '}
                        <small>With icons and avatars</small>
                    </CCardHeader>
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Chips can include icons, user avatars, or avatar
                            components to make tags easier to scan.
                        </p>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    <CCardHeader>
                        <strong>React Chip</strong>{' '}
                        <small>Variants and sizes</small>
                    </CCardHeader>
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Use the <code>color</code> prop for contextual
                            variants and the <code>size</code> prop for
                            different sizes.
                        </p>
                ...
                <CCard className="mb-4">
                    <CCardHeader>
                        <strong>React Chip</strong>{' '}
                        <small>Interactive examples</small>
                    </CCardHeader>
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Chips support selection, removal, and disabled
                            states using props like <code>selectable</code>,{' '}
                            <code>removable</code>, and <code>disabled</code>.
                        </p>
