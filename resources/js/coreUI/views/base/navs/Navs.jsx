        ...
        <CRow>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            The base <code>.nav</code> component is built with
                            flexbox and provide a strong foundation for building
                            all types of navigation components. It includes some
                            style overrides (for working with lists), some link
                            padding for larger hit areas, and basic disabled
                            styling.
                        </p>
                        ...
                        <p className="text-body-secondary small">
                            ...
                            super flexible. Use <code>&lt;ul&gt;</code>s like
                            above, <code>&lt;ol&gt;</code> if the order of your
                            items is important, or roll your own with a{' '}
                            <code>&lt;nav&gt;</code> element. Because the .nav
                            uses display: flex, the nav links behave the same as
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    <CCardHeader>
                        ...
                        <small>Horizontal alignment</small>
                    </CCardHeader>
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            . By default, navs are left-aligned, but you can
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Stack your navigation by changing the flex item
                            direction with the <code>.flex-column</code>{' '}
                            utility. Need to stack them on some viewports but
                            not others? Use the responsive versions (e.g.,{' '}
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            <code>variant=&#34;tabs&#34;</code> class to
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Force your <code>.nav</code>&#39;s contents to
                            extend the full available width one of two modifier
                            classes. To proportionately fill all available space
                            with your <code>.nav-item</code>s, use{' '}
                            <code>layout=&#34;fill&#34;</code>. Notice that all
                            horizontal space is occupied, but not every nav item
                            has the same width.
                        </p>
                        ...
                        <p className="text-body-secondary small">
                            ...
                            <code>layout=&#34;justified&#34;</code>. All
                            horizontal space will be occupied by nav links, but
                            unlike the .nav-fill above, every nav item will be
                            the same width.
                        </p>
                        <DocsExample href="components/nav-tabs#fill-and-justify">
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            If you need responsive nav variations, consider
                            using a series of{' '}
                            <a href="https://coreui.io/docs/utilities/flex">
                                flexbox utilities
                            </a>
                            . While more verbose, these utilities offer greater
                            customization across responsive breakpoints. In the
                            example below, our nav will be stacked on the lowest
                            breakpoint, then adapt to a horizontal layout that
                            fills the available width starting from the small
                            breakpoint.
                        </p>
