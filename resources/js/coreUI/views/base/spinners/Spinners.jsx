        ...
        <CRow>
            <CCol xs={12}>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        ...
                        <p className="text-body-secondary small">
                            The border spinner uses <code>currentColor</code>{' '}
                            for its <code>border-color</code>. You can use any
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            If you don&#39;tfancy a border spinner, switch to
                            the grow spinner. While it doesn&#39;t technically
                        ...
                        <p className="text-body-secondary small">
                            ...
                            <code>currentColor</code>, so you can easily change
                            its appearance. Here it is in blue, along with the
                            supported variants.
                        </p>
                        <DocsExample href="components/spinner#growing-spinner">
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Add <code>size=&#34;sm&#34;</code> property to make
                            a smaller spinner that can quickly be used within
                            other components.
                        </p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            currently processing or taking place. You may also
                            swap the text out of the spinner element and utilize
