                    ...
                    <CCardBody>
                        ...
                        <DocsExample href="components/tooltip">
                            <p className="text-body-secondary">
                                ...
                                haven&#39;theard of them. Photo booth beard raw
                                denim letterpress vegan messenger bag stumptown.
                                Farm-to-table seitan, mcsweeney&#39;s fixie
                                sustainable quinoa 8-bit american apparel
                                <CTooltip content="Tooltip text">
                                    <CLink> have a </CLink>
                                </CTooltip>
                                terry richardson vinyl chambray. Beard
                                stumptown, cardigans banh mi lomo thundercats.
                                Tofu biodiesel williamsburg marfa, four loko
                                ...
                                freegan cred raw denim single-origin coffee
                                viral.
                            </p>
                        </DocsExample>
                        <p className="text-body-secondary small">
                            Hover over the buttons below to see the four
                            tooltips directions: top, right, bottom, and left.
                            Directions are mirrored when using CoreUI in RTL.
                        </p>
                        <DocsExample href="components/tooltip">
                            <CTooltip
