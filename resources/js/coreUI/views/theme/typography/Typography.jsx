        ...
        <>
            <CCard className="mb-4">
                ...
                <CCardBody>
                    <p>
                        ...
                        including global settings, headings, body text, lists,
                        and more.
                    </p>
            ...
            <CCard className="mb-4">
                ...
                <div className="card-body">
                    <p>
                        Traditional heading elements are designed to work best
                        in the meat of your page content. When you need a
                        heading to stand out, consider using a{' '}
