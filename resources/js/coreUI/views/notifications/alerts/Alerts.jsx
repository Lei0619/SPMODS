        ...
        <CRow>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            React Alert is prepared for any length of text, as
                            well as an optional close button. For a styling, use
                            one of the <strong>required</strong> contextual{' '}
                            <code>color</code> props (e.g., <code>primary</code>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Use the <code>&lt;CAlertLink&gt;</code> component to
                            immediately give matching colored links inside any
                            alert.
                        </p>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Alert can also incorporate supplementary components
                            &amp; elements like heading, paragraph, and divider.
                        </p>
                    ...
                    <CCardBody>
                        ...
                        <DocsExample href="components/alert#dismissing">
                            <CAlert
                                ...
                                onClose={() => {
                                    alert(
                                        '👋 Well, hi there! Thanks for dismissing me.',
                                    );
                                }}
                            >
                                <strong>Go right ahead</strong> and click that
                                dimiss over there on the right.
                            </CAlert>
                        </DocsExample>
                    </CCardBody>
                </CCard>
