    ...
    return (
        <>
            ...
            >
                ...
                <CModalBody>
                    I will not close if you click outside me. Don&#39;teven try
                    to press escape key.
                </CModalBody>
                <CModalFooter>
                    <CButton
        ...
        <CRow>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            <code>position</code> and <code>display</code> have
                            been overridden). Included are the modal header,
                            modal body (required for <code>padding</code>), and
                            modal footer (optional). We ask that you include
                            modal headers with dismiss actions whenever
                            possible, or provide another explicit dismiss
                            action.
                        </p>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    <CCardHeader>
                        <strong>React Modal</strong>{' '}
                        <small>Static backdrop</small>
                    </CCardHeader>
                    <CCardBody>
                        <p className="text-body-secondary small">
                            If you don’t provide an <code>onDimsiss</code>{' '}
                            handler to the Modal component, your modal will
                            behave as though the backdrop is static, meaning it
                            will not close when clicking outside it. Click the
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    <CCardHeader>
                        <strong>React Modal</strong>{' '}
                        <small>Scrolling long content</small>
                    </CCardHeader>
                    <CCardBody>
                        <p className="text-body-secondary small">
                            If you don’t provide an <code>onDimsiss</code>{' '}
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            <code>&lt;CModal&gt;</code> to vertically center the
                            modal.
                        </p>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    <CCardHeader>
                        <strong>React Modal</strong>{' '}
                        <small>Tooltips and popovers</small>
                    </CCardHeader>
                    <CCardBody>
                        <p className="text-body-secondary small">
                            <code>&lt;CTooltips&gt;</code> and{' '}
                            <code>&lt;CPopovers&gt;</code> can be placed within
                            modals as needed. When modals are closed, any
                            tooltips and popovers within are also automatically
                            dismissed.
                        </p>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    <CCardHeader>
                        <strong>React Modal</strong>{' '}
                        <small>Optional sizes</small>
                    </CCardHeader>
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Modals have three optional sizes, available via
                            modifier classes to be placed on a{' '}
                            <code>&lt;CModal&gt;</code>. These sizes kick in at
                            certain breakpoints to avoid horizontal scrollbars
