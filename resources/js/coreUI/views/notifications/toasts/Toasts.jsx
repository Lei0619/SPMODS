        ...
        <CRow>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Toasts are slightly translucent to blend in with
                            what&#39;s below them.
                        </p>
                        <DocsExample
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            You can stack toasts by wrapping them in a toast
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            tweaking them with{' '}
                            <a href="https://coreui.io/docs/utilities/api">
                                utilities
                            </a>
                            , or by adding your own markup. Here we&#39;ve
                            created a simpler toast by removing the default{' '}
                            <code>&lt;CToastHeader&gt;</code>, adding a custom
                            hide icon from{' '}
                        ...
                        <DocsExample href="components/toast#custom-content">
                            ...
                            >
                                <div className="d-flex">
                                    ...
                                    <CToastClose className="m-auto me-2" />
                                </div>
                            </CToast>
                        </DocsExample>
                        <p className="text-body-secondary small">
                            Alternatively, you can also add additional controls
                            and components to toasts.
                        </p>
                        <DocsExample href="components/toast#custom-content">
                            <CToast autohide={false} visible={true}>
                                <CToastBody>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Building on the above example, you can create
                            different toast color schemes with our{' '}
                            <a href="https://coreui.io/docs/utilities/colors">
                                color
                            </a>{' '}
                            and{' '}
                            <a href="https://coreui.io/docs/utilities/background">
                                background
                            </a>{' '}
                            utilities. Here we&#39;ve set{' '}
                            <code>color=&#34;primary&#34;</code> and added{' '}
                            <code>.text-white</code> class to the{' '}
                            <code>&lt;Ctoast&gt;</code>, and then set{' '}
                            <code>white</code> property to our close button. For
                            a crisp edge, we remove the default border with{' '}
                            <code>.border-0</code>.
                        </p>
