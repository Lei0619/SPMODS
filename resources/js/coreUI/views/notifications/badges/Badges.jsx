        ...
        <CRow>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Bootstrap badge scale to suit the size of the parent
                            element by using relative font sizing and{' '}
                            <code>em</code> units.
                        </p>
                        <DocsExample href="components/badge">
                            <h1>
                                Example heading{' '}
                                <CBadge color="secondary">New</CBadge>
                            </h1>
                            <h2>
                                Example heading{' '}
                                <CBadge color="secondary">New</CBadge>
                        ...
                        <DocsExample href="components/badge">
                            <CButton color="primary">
                                Notifications{' '}
                                <CBadge color="secondary">4</CBadge>
                            </CButton>
                        </DocsExample>
                        <p className="text-body-secondary small">
                            Remark that depending on how you use them, badges
                            may be complicated for users of screen readers and
                            related assistive technologies.
                        </p>
                        <p className="text-body-secondary small">
                            Unless the context is clear, consider including
                            additional context with a visually hidden piece of
                            additional text.
                        </p>
                        <DocsExample href="components/badge">
                            <CButton color="primary">
            ...
            <CCol lg={6}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Add any of the below-mentioned <code>color</code>{' '}
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Apply the <code>shape=&#34;rounded-pill&#34;</code>{' '}
