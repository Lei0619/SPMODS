        ...
        <CRow>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            For custom CoreUI form validation messages,
                            you&#39;ll need to add the <code>noValidate</code>{' '}
                            boolean property to your <code>&lt;CForm&gt;</code>.
                            This disables the browser default feedback tooltips,
                            but still provides access to the form validation
                            APIs in JavaScript. Try to submit the form below;
                            our JavaScript will intercept the submit button and
                            relay feedback to you. When attempting to submit,
                            you&#39;ll see the <code>:invalid</code> and{' '}
                            <code>:valid</code> styles applied to your form
                            controls.
                        </p>
                        <p className="text-body-secondary small">
                            Custom feedback styles apply custom colors, borders,
                            focus styles, and background icons to better
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            case you require server-side validation, you can
                            indicate invalid and valid form fields with{' '}
                            <code>invalid</code> and <code>valid</code> boolean
                            properties.
                        </p>
                        <p className="text-body-secondary small">
                            For invalid fields, ensure that the invalid
                            feedback/error message is associated with the
                            relevant form field using{' '}
                            <code>aria-describedby</code> (noting that this
                            attribute allows more than one <code>id</code> to be
                        ...
                        <DocsExample href="forms/validation#server-side">
                            <CForm className="row g-3 needs-validation">
                                ...
                                <CCol md={6}>
                                    <CFormLabel htmlFor="validationServer03">
                                        City
                                    </CFormLabel>
                                    <CFormInput
                                        type="text"
                                ...
                                <CCol md={3}>
                                    <CFormLabel htmlFor="validationServer04">
                                        City
                                    </CFormLabel>
                                    <CFormSelect
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    <CCardHeader>
                        <strong>Validation</strong>{' '}
                        <small>Supported elements</small>
                    </CCardHeader>
                    <CCardBody>
                        <p className="text-body-secondary small">
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            for the tooltip to display validation feedback in a
                            styled tooltip. Be sure to have a parent with{' '}
                            <code>position: relative</code> on it for tooltip
                            positioning. In the example below, our column
                            classes have this already, but your project may
