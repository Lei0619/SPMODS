        ...
        <CRow>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Add the <code>readOnly</code> boolean attribute on
                            an input to prevent modification of the input&#39;s
                            value. Read-only inputs appear lighter (just like
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            If you want to have{' '}
                            <code>&lt;input readonly&gt;</code> elements in your
                            form styled as plain text, use the{' '}
                            <code>plainText</code> boolean property to remove
                            the default form field styling and preserve the
