        ...
        <CRow>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            <code>&lt;CFormLabel&gt;</code>s outside the input
                            group.
                        </p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            custom form field validation within an input group.
                            You may disable this with <code>.flex-nowrap</code>.
                        </p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            <code>&lt;CInputGroup&gt;</code> itself and contents
                            within will automatically resize—no need for
                            repeating the form control size classes on each
                            element.
                        </p>
                        <p className="text-body-secondary small">
                            <strong>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    <CCardHeader>
                        <strong>React Input group</strong>{' '}
                        <small>Multiple inputs</small>
                    </CCardHeader>
                    <CCardBody>
                        <p className="text-body-secondary small">
                            While multiple <code>&lt;CFormInput&gt;</code>s are
