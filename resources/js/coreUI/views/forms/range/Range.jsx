        ...
        <CRow>
            <CCol xs={12}>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        ...
                        >
                            <CFormLabel htmlFor="customRange1">
                                Example range
                            </CFormLabel>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Add the <code>disabled</code> boolean attribute on
                            an input to give it a grayed out appearance and
                        ...
                        <DocsExample
                            ...
                            tabContentClassName="bg-opacity-10"
                        >
                            <CFormLabel htmlFor="disabledRange">
                                Disabled range
                            </CFormLabel>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            <code>min</code> and <code>max</code>—<code>0</code>{' '}
                            and <code>100</code>, respectively. You may specify
                            new values for those using the <code>min</code> and{' '}
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            values. To change this, you can specify a{' '}
                            <code>step</code> value. In the example below, we
                            double the number of steps by using{' '}
                            <code>step=&#34;0.5&#34;</code>.
                        </p>
                        <DocsExample
                            ...
                            tabContentClassName="bg-opacity-10"
                        >
                            <CFormLabel htmlFor="customRange3">
                                Example range
                            </CFormLabel>
                            <CFormRange
                                min={0}
