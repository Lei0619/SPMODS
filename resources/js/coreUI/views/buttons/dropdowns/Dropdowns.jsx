                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            virtually the same markup as single button
                            dropdowns, but with the addition of boolean prop{' '}
                            <code>split</code> for proper spacing around the
                            dropdown caret.
                        </p>
                        <p className="text-body-secondary small">
                            We use this extra class to reduce the horizontal{' '}
                            <code>padding</code> on either side of the caret by
                            25% and remove the <code>margin-left</code>{' '}
                            that&#39;s attached for normal button dropdowns.
                            Those additional changes hold the caret centered in
                            the split button and implement a more properly sized
                            hit area next to the main button.
                        </p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            custom style by set <code>dark</code> property. No
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            by adding <code>direction=&#34;dropend&#34;</code>{' '}
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            by adding <code>direction=&#34;dropstart&#34;</code>{' '}
                            to the <code>&lt;CDropdown&gt;</code> component.
                        </p>
