        ...
        <CRow>
            <CCol xs={12}>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p>
                            Wrap a series of <code>&lt;CButton&gt;</code>{' '}
                            components in <code>&lt;CButtonGroup&gt;</code>
                            .{' '}
                        </p>
                        ...
                        <p>
                            ...
                            as an alternative to the <code>&lt;CNav&gt;</code>{' '}
                            components.
                        </p>
                        <DocsExample href="components/button-group">
                            <CButtonGroup>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p>
                            Combine button-like checkbox and radio toggle
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p>
                            Join sets of button groups into button toolbars for
                            more complicated components. Use utility classes as
                        ...
                        <p>
                            Feel free to combine input groups with button groups
                            in your toolbars. Similar to the example above,
                            you’ll likely need some utilities through to space
                            items correctly.
                        </p>
                        <DocsExample href="components/button-group#button-toolbar">
                            <CButtonToolbar
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p>
                            Alternatively, of implementing button sizing classes
                            to each button in a group, set <code>size</code>{' '}
                            property to all <code>&lt;CButtonGroup&gt;</code>
                            &#39;s, including each one when nesting multiple
                            groups.
                        </p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Put a <code>&lt;CButtonGroup&gt;</code> inside
                            another <code>&lt;CButtonGroup&gt;</code> when you
                            need dropdown menus combined with a series of
                            buttons.
                        </p>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    <CCardHeader>
                        <strong>React Button Group</strong>{' '}
                        <span>Vertical variation</span>
                    </CCardHeader>
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Create a set of buttons that appear vertically
                            stacked rather than horizontally.{' '}
                            <strong>
