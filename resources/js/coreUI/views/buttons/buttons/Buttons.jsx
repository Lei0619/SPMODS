        ...
        <CRow>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            CoreUI includes a bunch of predefined buttons
                            components, each serving its own semantic purpose.
                            Buttons show what action will happen when the user
                            clicks or touches it. CoreUI buttons are used to
                            initialize operations, both in the background or
                            foreground of an experience.
                        </p>
                        <DocsExample href="components/buttons">
                            {['normal', 'active', 'disabled'].map(
                                (state, index) => (
                                    <CRow
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            The <code>&lt;CButton&gt;</code> component are
                            designed for <code>&lt;button&gt;</code> ,{' '}
                            <code>&lt;a&gt;</code> or <code>&lt;input&gt;</code>{' '}
                            elements (though some browsers may apply a slightly
                            different rendering).
                        </p>
                        <p className="text-body-secondary small">
                            If you&#39;re using <code>&lt;CButton&gt;</code>{' '}
                            component as <code>&lt;a&gt;</code> elements that
                            are used to trigger functionality ex. collapsing
                            content, these links should be given a{' '}
                            <code>role=&#34;button&#34;</code> to adequately
                            communicate their meaning to assistive technologies
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            If you need a button, but without the strong
                            background colors. Set{' '}
                            <code>variant=&#34;outline&#34;</code> prop to
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            <code>variant=&#34;ghost&#34;</code> prop to remove
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            <code>&lt;CButton&gt;</code> component to make
                            buttons look inactive. Disabled button has{' '}
                            <code>pointer-events: none</code> applied to,
                        ...
                        <p className="text-body-secondary small">
                            Disabled buttons using the <code>&lt;a&gt;</code>{' '}
                            component act a little different:
                        </p>
                        <p className="text-body-secondary small">
                            <code>&lt;a&gt;</code>s don&#39;tsupport the{' '}
                            <code>disabled</code> attribute, so CoreUI has to
                            add <code>.disabled</code> className to make buttons
                            look inactive. CoreUI also has to add to the
                            disabled button component{' '}
                            <code>aria-disabled=&#34;true&#34;</code> attribute
                            to show the state of the component to assistive
                            technologies.
                        </p>
                        <DocsExample href="components/buttons#disabled-state">
                            <CButton
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Create buttons that span the full width of a
                            parent—by using utilities.
                        </p>
                        ...
                        <p className="text-body-secondary small">
                            ...
                            vertically stacked buttons until the <code>md</code>{' '}
                            breakpoint, where <code>.d-md-block</code> replaces
                            the <code>.d-grid</code> class, thus nullifying the{' '}
                            <code>gap-2</code> utility. Resize your browser to
                            see them change.
                        </p>
                        <DocsExample href="components/buttons#block-buttons">
                        ...
                        <p className="text-body-secondary small">
                            ...
                            grid column width classes. For example, for a
                            half-width &#34;block button&#34;, use{' '}
                        ...
                        <p className="text-body-secondary small">
                            Additional utilities can be used to adjust the
                            alignment of buttons when horizontal. Here we&#39;ve
                            taken our previous responsive example and added some
                            flex utilities and a margin utility on the button to
                            right align the buttons when they&#39;re no longer
                            stacked.
                        </p>
                        <DocsExample href="components/buttons#block-buttons">
